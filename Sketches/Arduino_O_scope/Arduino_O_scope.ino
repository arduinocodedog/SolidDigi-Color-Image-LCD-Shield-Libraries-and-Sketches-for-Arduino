...
void	setup()
{
  ...
  LCDPutStr("Starting in:", 96, 10, GREEN, WHITE); // Startup Timer
  LCDPutStr("5", 112, 58, GREEN, WHITE);
  delay(1000);
  LCDPutStr("4", 112, 58, GREEN, WHITE);
  delay(1000);
  LCDPutStr("3", 112, 58, GREEN, WHITE);
  delay(1000);
  LCDPutStr("2", 112, 58, GREEN, WHITE);
  delay(1000);
  LCDPutStr("1", 112, 58, GREEN, WHITE);
  delay(1000);
  LCDPutStr("0", 112, 58, GREEN, WHITE);
  LCDClear(WHITE);    // Clear LCD to solid White
  ...
  LCDPutStr("3.3", 44, 92, ORANGE, WHITE);
  LCDPutStr("5v", 2, 102, RED, WHITE);
  //Write the speed
  if(drawSpeed == 1){
